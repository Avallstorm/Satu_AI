...
if cfg['new_model']:
    ...
    if cfg['weights_only']:
        textgen = textgenrnn(weights_path=cfg['weights_path'],name=cfg['model_name'])
        ...
        textgen = textgenrnn(weights_path=cfg['weights_path'],vocab_path=cfg['vocab_path'] ,config_path=cfg['config_path'],name=cfg['model_name'])
        textgen.train_on_texts(
            texts,
            context_labels=context_labels,
            num_epochs=cfg['num_epochs'],
